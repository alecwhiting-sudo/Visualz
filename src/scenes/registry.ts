...
import { TerrainScene } from './builtin/terrain'
...
import { FluidInkScene } from './builtin/fluidink'
...
const cymaticsChild: CompositeChild = { id: 'cymatics', label: 'Cymatics', create: () => new CymaticsScene() }
const starflightChild: CompositeChild = { id: 'starflight', label: 'Star Flight', create: () => new StarFlightScene() }
...
export const SCENES: Record<string, { name: string; create(): SceneRuntime }> = {
  ...
  terrain: { name: 'Terrain', create: () => new TerrainScene() },
  ...
  fluidink: { name: 'Fluid Ink', create: () => new FluidInkScene() },
  'blend-julia-flow': {
  ...
  'blend-cymatics-starflight': {
    name: 'Cymatics × Star Flight',
    create: () =>
      new CompositeScene(
        { id: 'blend-cymatics-starflight', name: 'Cymatics × Star Flight', family: 'geometry' },
        cymaticsChild,
        starflightChild,
      ),
  },
