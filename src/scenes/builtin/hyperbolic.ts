...
/**
 * STUB — being built (task #41): "Hyperbolic", the new wildcard:
 * a Poincaré-disk hyperbolic {p,q} tiling — infinitely repeating geometry
 * folding toward the disk rim, audio-breathing and rotating. This placeholder only
